...
bool cdr_serialize_nuturtlebot_msgs__msg__WheelCommands(
  const nuturtlebot_msgs__msg__WheelCommands * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nuturtlebot_msgs
bool cdr_deserialize_nuturtlebot_msgs__msg__WheelCommands(
  eprosima::fastcdr::Cdr & cdr,
  nuturtlebot_msgs__msg__WheelCommands * ros_message)
{
  // Field name: left_velocity
  {
    cdr >> ros_message->left_velocity;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nuturtlebot_msgs
bool cdr_serialize_key_nuturtlebot_msgs__msg__WheelCommands(
  const nuturtlebot_msgs__msg__WheelCommands * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: left_velocity
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nuturtlebot_msgs
size_t get_serialized_size_key_nuturtlebot_msgs__msg__WheelCommands(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WheelCommands__ros_msg_type * ros_message = static_cast<const _WheelCommands__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nuturtlebot_msgs
size_t max_serialized_size_key_nuturtlebot_msgs__msg__WheelCommands(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nuturtlebot_msgs__msg__WheelCommands * ros_message = static_cast<const nuturtlebot_msgs__msg__WheelCommands *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nuturtlebot_msgs__msg__WheelCommands(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nuturtlebot_msgs__msg__WheelCommands * ros_message = static_cast<nuturtlebot_msgs__msg__WheelCommands *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nuturtlebot_msgs__msg__WheelCommands(cdr, ros_message);
}
